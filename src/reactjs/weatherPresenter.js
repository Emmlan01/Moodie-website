...
export default function Weather(props) {
    ...
    function initialGetCurrentWeather(){
        ...
        props.model.getCurrentWeather(500, weatherPromiseState, notify)
    }
    ...
    return (<div>{promiseNoData(weatherPromiseState) || <MovieView weatherData={weatherPromiseState.data} clickOnReroll={rerollClickACB}/>}</div>)
